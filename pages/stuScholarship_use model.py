...
df_new=pd.read_csv(r"D:\Desktop\Student-ScholarshipManagement\data2.csv")
#图标
image=Image.open(r'D:\Desktop\Student-ScholarshipManagement\pictures\3.png')
st.image(image)
...
if col33.button("开始评定"):
    ...
    #图标
    image=Image.open(r'D:\Desktop\Student-ScholarshipManagement\pictures\4.png')
    st.image(image)
    st.write('---')
    #导出结果
    df_new_finished=pd.read_csv(r"D:\Desktop\Student-ScholarshipManagement\data3.csv")
    #导入表格
