...
#导入数据
df=pd.read_csv(r"D:\Desktop\Student-ScholarshipManagement\data1.csv")
...
#图标
image=Image.open(r'D:\Desktop\Student-ScholarshipManagement\pictures\5.png')
st.image(image)
st.write('---')
...
#图标
image=Image.open(r'D:\Desktop\Student-ScholarshipManagement\pictures\6.png')
st.image(image)
st.write('---')
